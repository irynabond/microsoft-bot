    ...
    public class SimpleAlarmDialog : LuisDialog<object>
    {
        ...
        public async Task SetAlarm(IDialogContext context, LuisResult result)
        {
            ...
            if (!result.TryFindEntity(Entity_Alarm_Title, out title))
            {
                ...
                title = new EntityRecommendation(null, null, Entity_Alarm_Title);
                title.Entity = DefaultAlarmWhat;
            }
        ...
        private Task AfterConfirming_TurnOffAlarm(IDialogContext context, IAwaitable<bool> result)
        {
